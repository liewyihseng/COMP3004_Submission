...
'''
Handles the initialisation and training of the PPO algorithm on green channel
'''
...
Output parameter:
    env: representing the environment where consisting only pixel values from the green colour channel
'''
